...
public class GettingStarted2 {
	...
	public static void main(String[] args) {
		try {
			...
			// IOUtils.copy(new BufferedInputStream(null), new BufferedOutputStream(null));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void doConversion2(String htmlDocument, String outputPath)
		...
		pd4ml.setHtmlWidth(this.userSpaceWidth); // set frame width of "virtual web browser"

		// choose target paper format
		pd4ml.setPageSize(pd4ml.changePageOrientation(PD4Constants.A4));

		// define PDF page margins
		pd4ml.setPageInsetsMM(new Insets(this.topValue, this.leftValue, this.bottomValue, this.rightValue));
